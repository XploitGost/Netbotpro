...
class ReleaseReadinessTests(unittest.TestCase):
    ...
    def test_performance_pipeline_docs_are_linked_and_scoped(self):
        ...
        self.assertIn("docs/REAL_LOAD_TESTING.md", readme)
        self.assertTrue((REPO_ROOT / "docs/REAL_LOAD_TESTING.md").is_file())
        ...
        real_load = self._read("docs/REAL_LOAD_TESTING.md")
        real_load_lower = real_load.lower()
        self.assertIn("long_soak_runner.py", real_load)
        self.assertIn("light_desktop", real_load)
        self.assertIn("server_medium", real_load)
        self.assertIn("no unbounded growth", real_load_lower)
        self.assertIn("does not export raw payloads", real_load_lower)
